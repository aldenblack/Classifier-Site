...
IMAGE_FOLDER = r"C:\Users\droso\Documents\Image-Splitting\2 21\C pops" #os.path.join(BASE_DIR, 'image-bank')#r"C:\Users\droso\Documents\Classifier-Site\image-bank"
...
def get_next_image():
    images = [f for f in os.listdir(IMAGE_FOLDER) if f.endswith('.jpg') and not f.startswith(('p', 'n', 's'))]
